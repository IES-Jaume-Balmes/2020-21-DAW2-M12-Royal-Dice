    ...
    <div class="info-perfil"><!--FOTO PERFIL // MONEDAS // USERNAME-->
            ...
            <a href="{{ route('perfil') }}"><div class="contenedor">{{ Auth::user()->name }}</div></a>
            <a href="{{ route('cajero') }}"><div href="{{ route('cajero') }}" class="monedas" id="fichas">{{ Auth::user()->fichas }} FICHAS</div></a>
